...
#SBATCH -o /home/francl/convolve_stim.stdout
#SBATCH -e /home/francl/convolve_stim.stder
#SBATCH --ntasks=1
#SBATCH -c 2
...
singularity exec --nv -B /om -B /nobackup /om/user/francl/SoundLocalization/tf1.4.simg python -u convolve_stim_vary_env_no_hanning.py $trainingID
